// ✅ MegaTron Bot Stylish Configuration – by 𝗨𝗦𝗠𝗔𝗡 ❦ ✓

const ownerNumber = require('./Owner/owner'); // 🔗 Example: ['93776544491']

const config = {
  // 👑 Owner Info
  ownerNumber,                          // 🔹 Array of Owner Numbers
  ownerName: '𓆩 𝗨𝗦𝗠𝗔𝗡 ❦︎𓆪',              // 🔹 Displayed in Greetings
  botName: '🤖 𝗠𝗘𝗚𝗔𝐓𝐑𝐎𝐍 𝑩𝑶𝑻 ⚡',           // 🔹 Bot Display Name
  signature: '> 𝗨𝗦𝗠𝗔𝗡 ❦ ✓',               // 🔹 Footer on Bot Replies
  channel: 'https://whatsapp.com/channel/0029Vb6SwB147XeCTHpikc0O', // 🔹 Optional Whatsapp Channel
